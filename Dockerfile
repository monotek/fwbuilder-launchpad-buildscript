...
RUN apt-get update -y;apt-get -y upgrade; \
    apt-get install --no-install-recommends -y build-essential cdbs cmake debhelper devscripts dput git libsnmp-dev libdistro-info-perl libqt4-dev libxml2-dev libxslt1-dev pkg-config qt4-dev-tools qt5-qmake-bin qtbase5-dev qttools5-dev-tools zlib1g-dev 
