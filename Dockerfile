...
RUN apt-get update -y;apt-get -y upgrade; \
    apt-get install -y build-essential cdbs cmake debhelper devscripts dput git libsnmp-dev libxml2-dev libxslt1-dev pkg-config qtbase5-dev qttools5-dev-tools zlib1g-dev 
